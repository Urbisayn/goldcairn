...
Initiative & Actions
The following Initiative system is inspired by the one featured in the amazing Errant. This system works best in situations where there are two or more parties with weapons drawn, sizing each other up.

For most moments, a regular “Make a DEX Save to go before the enemy” ruling (as in base Cairn) works perfectly fine. For more tactical depth, consider the following rules:

Declare Actions
At the start of a round, each PC declares their intentions that round. The Warden decides what the enemies will do, and will telegraph this to some degree when prompted: “The orc seems focused on Mirah, his sword drawn”.
...
Quick turns, consisting of a single action. If any players and enemies both take a quick turn, resolve with a DEX Save.
Full turns, consisting of two actions or a slow action such as casting magic or a miracle. If any players and enemies both take a full turn, resolve with a DEX Save.
Range Bands
...
Parry. Choose one attacking opponent that you can attack in return: -- If you roll higher attack damage than they do, their dice roll is invalidated, and you deal your damage straight to their STR. This does not trigger a Critical Damage Save. -- If the opponent rolls higher, the damage is dealt to your STR instead. This does not trigger a Critical Damage Save. -- If the two rolls are equal, both weapons bounce off each other with a satisfying twing! and a rain of sparks. No damage is done to either party.
